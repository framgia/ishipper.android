...
public class APIDefinition {
    ...
    private static final String DEV_URL = "http://192.168.1.116:3001/";
    ...
    public class GetAllNotification {
        public static final String PARAM_USER_TYPE = "user_type";
        public static final String PARAM_NOTIFICATION_PAGE = "notificationItem[page]";
        public static final String PARAM_PER_PAGE = "notificationItem[per_page]";
