 ...
 */
public class ShipperInvoiceManagerFragment extends InvoiceManagerFragment {
    ...
    private void init() {
        ...
        mListInvoiceTitle.add(getString(R.string.tab_title_order_wait));
        mListInvoiceTitle.add(getString(R.string.tab_title_take_order));
