 ...
 */
public class ShipperOrderManagerFragment extends OrderManagerFragment {
    ...
    private void init() {
        ...
        mListOrderTitle.add(getString(R.string.tab_title_order_wait));
        mListOrderTitle.add(getString(R.string.tab_title_take_order));
